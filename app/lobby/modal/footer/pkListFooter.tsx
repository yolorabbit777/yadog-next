...
export default function PkListFooter({setRankingModalShow}: {setRankingModalShow:(status: boolean) => void}) {
        ...
        <div className="absolute w-full h-full px-4 -translate-y-[50px]">
            <div className="w-full flex flex-row justify-between items-start py-3 px-5 bg-white h-full rounded-[30px] shadow-inner shadow-[#444]">
                <div className="flex items-center gap-2">
                    ...
                    <Image src="/images/guild/avatar.png" alt="avatar" width={47} height={47} />
                    <p className="text-[15px] font-medium text-[#523705]">小狗測試員</p> 
                </div>
                <div className="flex items-center gap-1">
                    <p className="text-[30px] font-black text-[#523705]">14</p> 
                    <div className="flex flex-col">
                        <div className="px-1 py-[1px] rounded-xl bg-[#00FF00]">
                            <p className="text-[15px] font-black text-white">60%</p> 
                        </div>
                        <p className="text-[15px] font-black text-[#523705]">勝</p> 
                    </div>
                </div>
            </div>
        </div>
