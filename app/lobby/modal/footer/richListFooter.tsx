...
export default function RichListFooter({setRankingModalShow}: {setRankingModalShow:(status: boolean) => void}) {
        ...
        <div className="absolute w-full h-full px-4 -translate-y-[50px]">
            <div className="w-full flex flex-row justify-between items-start py-3 px-5 bg-white h-full rounded-[30px] shadow-inner shadow-[#444]">
                ...
                <div className="flex items-center">
                    <Image src="/images/guild/footprinter@3x.png" alt="footprinter" width={40} height={40} />
                    <p className="text-[15px] font-black text-[#523705]">211,803,456</p> 
                </div>
            </div>
        </div>
